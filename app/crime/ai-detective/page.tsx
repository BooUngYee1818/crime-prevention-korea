    ...
    items: [
      {
        isAI: true,
        thumb: "🌆",
        bg: "linear-gradient(135deg,#1a1a1a,#0f0f1a)",
        label: "영상 A",
    ...
    items: [
      {
        isAI: false,
        thumb: "👁️",
        bg: "linear-gradient(135deg,#1e1e2e,#181828)",
        label: "영상 A",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        isAI: false,
        thumb: "🗣️",
        bg: "linear-gradient(135deg,#0a1a0a,#081408)",
        label: "영상 B",
...
const BADGES = [
  ...
  { min: 4, max: 4, icon: "🦸", name: "AI 탐정", color: "#3b82f6", desc: "거의 다 맞췄어요! AI 눈을 가졌네요!" },
    ...
    <div style={{ minHeight: "100vh", background: "#050508", color: "#f4f4f5", fontFamily: "'Apple SD Gothic Neo','Noto Sans KR',sans-serif" }}>
      ...
      {phase === "intro" && (
        <div style={{ maxWidth: 560, margin: "0 auto", padding: "48px 24px", textAlign: "center", animation: "fadeUp 0.4s ease" }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: 14, lineHeight: 1.9, marginBottom: 28 }}>
            요즘 사기꾼들은 <strong style={{ color: "#f472b6" }}>AI로 만든 가짜 영상</strong>으로 사람들을 속여요.<br />
          ...
          <div style={{ background: "#0f0f1a", border: "1px solid #1e1e2e", borderRadius: 16, padding: "18px 20px", marginBottom: 28, textAlign: "left" }}>
            ...
            {["손가락 개수가 이상해요", "배경 글자가 뭉개져 있어요", "눈 깜빡임이 너무 적어요", "입 모양과 소리가 맞지 않아요", "너무 완벽한 얼굴 대칭"].map((t, i) => (
              <p key={i} style={{ color: "#6b7280", fontSize: 12, lineHeight: 1.8, paddingLeft: 8, borderLeft: "2px solid #1e1e2e" }}>{t}</p>
            ))}
          </div>
      ...
      {phase === "quiz" && (
        <div style={{ maxWidth: 600, margin: "0 auto", padding: "32px 20px", animation: "fadeUp 0.3s ease" }}>
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 24 }}>
            {ROUNDS.map((_, i) => (
              <div key={i} style={{ flex: 1, height: 5, borderRadius: 3, background: i < round ? "#22c55e" : i === round ? "#fbbf24" : "#1e1e2e", transition: "background 0.3s" }} />
            ))}
          </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: `2px solid ${isCorrect ? "#22c55e" : isWrong ? "#ef4444" : isSelected ? "#fbbf24" : "#1e1e2e"}`,
          ...
          {/* 해설 */}
          {showExplain && (
            <div style={{ background: "#0a1a0a", border: "1px solid #22c55e33", borderRadius: 14, padding: "16px 18px", marginBottom: 16, animation: "fadeUp 0.3s ease" }}>
          ...
          {!confirmed ? (
            <button
              ...
              style={{ width: "100%", padding: "14px", borderRadius: 14, fontWeight: 700, fontSize: 15, border: "none", cursor: selected === null ? "default" : "pointer", background: selected === null ? "#1e1e2e" : "linear-gradient(135deg,#fbbf24,#d97706)", color: selected === null ? "#374151" : "#fff" }}
            >
      ...
      {phase === "result" && (
        <div style={{ maxWidth: 560, margin: "0 auto", padding: "40px 20px", textAlign: "center" }}>
          ...
          {/* 3점 미만 — 격려 */}
          {score < 3 && (
            <div style={{ background: "#0f0f1a", border: "1px solid #1e1e2e", borderRadius: 14, padding: "16px 20px", marginBottom: 24, textAlign: "left" as const }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            <button onClick={reset} style={{ flex: 1, padding: "14px", borderRadius: 14, fontWeight: 700, fontSize: 14, background: "#1e1e2e", border: "1px solid #374151", color: "#94a3b8", cursor: "pointer" }}>
              다시 도전
            </button>
