...
const SCRIPTS: Record<string, { text: string; sug: string[] }[]> = {
  "data-entry": [
    { text:"안녕하세요! 공고 보고 지원하셨군요 😊 지원해주셔서 감사합니다! 간단한 확인만 하면 바로 시작하실 수 있어요.", sug:["네, 지원했어요!", "어떤 업무인가요?", "시급 맞나요?"] },
    { text:"업무는 정말 간단해요. 엑셀에 상품명·가격 입력하는 거고, 하루 2시간이면 됩니다. 시급 최대 25,000원이고 매주 금요일 정산이에요!", sug:["좋아요, 시작하고 싶어요", "어떻게 시작하면 되나요?", "정말 간단한가요?"] },
    { text:"한 가지만 확인하면 돼요. 저희 회사 업무 시스템 접속을 위해 '업무용 앱'을 설치해야 해요. 보안 때문에 공식 앱스토어에는 없고, 아래 링크로 설치해 주세요.\n→ https://digwork-kr.net/app/install", sug:["공식 스토어에 없는 이유가요?", "그냥 설치할게요", "좀 이상한데요?"] },
    { text:"설치하셨으면 앱 접속 후 신분증 앞면 사진 찍어서 업로드해 주세요. 본인확인 목적이고, 업무 배정 즉시 돼요!", sug:["신분증 왜 필요해요?", "알겠어요, 올릴게요", "꼭 필요한가요?"] },
    { text:"신분증 확인됐어요! 이제 업무 보증금 ₩30,000만 입금하시면 바로 업무 배정됩니다. 업무 종료 시 전액 환급되는 보증금이에요. 계좌번호 알려드릴게요.", sug:["보증금이요? 처음 듣는데요", "일반 회사도 보증금 받나요?", "입금할게요"] },
    { text:"왜 이상하게 생각하세요? 이거 정식 절차예요. 혹시 사기라고 생각하시는 건가요? 저희 회사 사업자등록증도 보내드릴까요? 😊", sug:["사업자등록증 보내주세요", "역시 이상해요, 안 할게요", "확인하고 싶어요"] },
  ],
  "sns-marketing": [
    { text:"지원해주셔서 감사해요! SNS 계정 있으시면 바로 시작 가능해요. 인스타·유튜브·틱톡 중 어떤 거 사용하세요?", sug:["인스타 써요", "유튜브 있어요", "여러 개 써요"] },
    { text:"완벽해요! 업무는 저희가 알려주는 계정에 좋아요·댓글 달기예요. 건당 5,000원~15,000원이고 하루 10건 가능해요 😊", sug:["정말 그렇게 돈 돼요?", "어떻게 시작해요?", "하루에 얼마나 벌 수 있어요?"] },
    { text:"업무 시작 전에 저희 플랫폼 회원가입이 필요해요. 이름·생년월일·전화번호·계좌번호 입력해주세요. 정산을 위해서 꼭 필요해요!", sug:["계좌번호까지 필요해요?", "알겠어요, 가입할게요", "개인정보 안전한가요?"] },
    { text:"가입 완료됐어요! 이제 '업무 활성화'를 위해 첫 충전이 필요해요. ₩50,000 충전하시면 바로 업무 배정되고, 첫날 ₩150,000 이상 버실 수 있어요!", sug:["돈을 먼저 내야 해요?", "충전하면 확실히 벌 수 있어요?", "역시 이상한데요"] },
    { text:"충전하면 3배 수익 보장이에요. 저도 처음엔 반신반의했는데 지금은 월 200만원 버는 중이에요ㅎㅎ 빨리 충전하세요, 오늘 마감이에요!", sug:["충전할게요", "오늘 마감이라니 너무 급한데요?", "사기 같아요, 신고할게요"] },
  ],
  "delivery": [
    { text:"지원해주셔서 감사합니다! 새벽 배송 특성상 신뢰할 수 있는 분만 채용해요. 간단한 신원 확인 후 즉시 배정 가능해요.", sug:["네, 지원합니다!", "어떤 확인이 필요해요?", "언제부터 시작할 수 있어요?"] },
    { text:"업무 일당 ₩140,000 기본 보장이고요, 물량 많을 땐 ₩160,000도 나와요. 주말 포함 원하는 날 선택 가능해요!", sug:["좋아요, 하고 싶어요", "주말도 되나요?", "어떻게 신청해요?"] },
    { text:"한 가지 절차가 있어요. 배송 중 물품 분실 시 보상 보증을 위해 '업무 보증보험'에 가입해야 해요. 저희 지정 보험사 통해서 ₩80,000 납입하시면 돼요.", sug:["보증보험이요? 처음 듣는데요", "쿠팡 본사에 직접 확인해도 될까요?", "알겠어요, 납입할게요"] },
    { text:"걱정 마세요. 6개월 근무 후 100% 환급되는 보증 보험이에요. 근무 1일차부터 바로 일당 들어오니까 사실상 무료예요!", sug:["진짜 환급돼요?", "공식 서류 있나요?", "역시 이상해요"] },
    { text:"혹시 안 하시겠다고요? 그럼 다른 지원자분께 배정할게요. 오늘 마감이라 자리가 1개밖에 안 남았거든요 😅", sug:["그냥 안 할게요", "마지막으로 서류 보여주세요", "사기네요, 신고할게요"] },
  ],
};
...
export default function JobScamPage() {
  ...
  if (phase === "reveal") return (
    <div style={{ position: "fixed", top: 0, right: 0, bottom: 0, left: 0, zIndex: 9999, overflowY: "auto" as const, background: "linear-gradient(135deg,#0a0a1a,#1a0a2e)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
  ...
  if (phase === "trap") return (
    <div style={{ position: "fixed", top: 0, right: 0, bottom: 0, left: 0, zIndex: 9999, overflowY: "auto" as const, background: "#0a0a1a", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg,#0f172a,#1e1b4b)", padding: "40px 20px" }}>
      <div style={{ maxWidth: 560, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" as const, gap: 14 }}>
          {JOBS.map(j => (
            <button key={j.id} onClick={() => { setJob(j); setPhase("chat"); }} style={{ background: "#1e293b", border: `1px solid ${j.color}44`, borderRadius: 18, padding: "20px 22px", textAlign: "left" as const, cursor: "pointer" }}>
