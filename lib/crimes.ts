...
export const CRIME_SCENARIOS: CrimeScenario[] = [
  ...
  },
  {
    ...
    subtitle: "AI가 요약해준 링크를 눌렀더니 계정이 털렸어요",
    icon: "🤖",
    color: "#06b6d4",
    targetAge: "future",
    reveal: {
      crimeName: "챗지피시 — AI 간접 프롬프트 주입 피싱 (2024~현재)",
      description: "공격자가 웹페이지에 눈에 보이지 않는 악성 명령어를 심어두면, AI가 그 페이지를 요약할 때 피싱 링크·가짜 로그인 화면을 생성하도록 조작됩니다. 사용자는 '신뢰하는 AI의 답변'으로 착각해 별 의심 없이 클릭합니다. 이를 간접 프롬프트 주입(Indirect Prompt Injection)이라 부르며, 금융 인증 정보·계정 비밀번호 탈취에 실제 악용된 정황이 확인됐습니다.",
      howToAvoid: [
        "AI가 제공한 링크라도 반드시 주소창에서 실제 URL 확인",
        "AI 요약 결과의 로그인 화면은 절대 신뢰하지 않기 — 공식 앱·북마크 직접 접속",
        "금융·포털 계정은 2단계 인증(2FA) 필수 설정",
        "수상한 페이지 열람 후 AI가 엉뚱한 링크를 제시하면 즉시 창 닫고 신고",
        "피해 발생 시 KISA 인터넷침해대응센터 118 신고",
      ],
      stats: "2024년 해외 사례 다수 확인 · AI 플랫폼 악용 피싱 전년 대비 급증 추세 · 국내 보안뉴스 2025년 공식 경고",
      reportNumber: "118",
      kidExplanation: "🧒 쉽게 말하면: AI한테 '이 웹사이트 요약해줘'라고 했는데, 나쁜 사람이 그 웹사이트에 몰래 함정을 숨겨놨어요. 그러면 AI가 자기도 모르게 나쁜 링크를 알려줄 수 있어요. AI가 알려준 링크라도 꼭 직접 확인해야 해요!",
    },
  },
];
