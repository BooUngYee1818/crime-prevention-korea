...
export const T = {
  ...
  report_kisa:    { ko: "인터넷진흥원", en: "Internet Security Agency", ja: "インターネット振興院", zh: "互联网振兴院", vi: "Cơ quan An ninh mạng", es: "Agencia de Seguridad en Internet" },
  report_gamble:  { ko: "도박중독 상담", en: "Gambling Helpline", ja: "ギャンブル依存相談", zh: "赌博成瘾咨询", vi: "Đường dây cờ bạc", es: "Línea de juego" },

  // ── HOME PAGE ─────────────────────────────────────────────────────
  popup1_start:      { ko: "체험 시작하기 →", en: "Start Experience →", ja: "体験を始める →", zh: "开始体验 →", vi: "Bắt đầu →", es: "Comenzar →" },
  popup2_who:        { ko: "누구와 함께 사용하시나요?", en: "Who are you using this with?", ja: "誰と一緒に使いますか？", zh: "您和谁一起使用？", vi: "Bạn sử dụng với ai?", es: "¿Con quién usas esto?" },
  popup2_guide:      { ko: "상황에 맞는 활용 방법을 안내해 드립니다.", en: "We'll guide you with the right tips for your situation.", ja: "状況に合った活用方法をご案内します。", zh: "我们将为您提供适合您情况的使用建议。", vi: "Chúng tôi sẽ hướng dẫn bạn cách sử dụng phù hợp.", es: "Te guiaremos con los mejores consejos para tu situación." },
  popup2_go:         { ko: "바로 체험 시작하기 →", en: "Start Now →", ja: "今すぐ体験 →", zh: "立即开始 →", vi: "Bắt đầu ngay →", es: "Empezar ya →" },
  rainbow_report:    { ko: "2차 피해 예방 신고", en: "Report Crime", ja: "二次被害防止通報", zh: "举报犯罪", vi: "Báo cáo tội phạm", es: "Denunciar crimen" },
  nav_brand:         { ko: "범죄예방 체험관", en: "Crime Prevention Center", ja: "犯罪予防体験館", zh: "犯罪预防体验馆", vi: "Trung tâm Phòng chống Tội phạm", es: "Centro de Prevención del Crimen" },
  nav_edu_badge:     { ko: "교육 목적 전용", en: "Educational Use Only", ja: "教育目的専用", zh: "仅供教育目的", vi: "Chỉ dành cho giáo dục", es: "Solo uso educativo" },
  hero_alert:        { ko: "2025년 피해액 1조원 돌파", en: "2025 losses exceeded ₩1 trillion", ja: "2025年被害額1兆ウォン突破", zh: "2025年损失超过1万亿韩元", vi: "Tổn thất 2025 vượt 1 nghìn tỷ won", es: "Pérdidas 2025 superaron ₩1 billón" },
  hero_free_tag:     { ko: "완전 무료", en: "Completely Free", ja: "完全無料", zh: "完全免费", vi: "Hoàn toàn miễn phí", es: "Completamente gratis" },
  hero_no_money:     { ko: "실제 돈 없음", en: "No Real Money", ja: "実際のお金なし", zh: "无真实金钱", vi: "Không tiền thật", es: "Sin dinero real" },
  hero_edu_tag:      { ko: "교육 전용", en: "Education Only", ja: "教育専用", zh: "仅供教育", vi: "Chỉ giáo dục", es: "Solo educación" },
  hero_edu_notice:   { ko: "AI가 사기범 역할을 연기하지만 실제 돈은 절대 나가지 않습니다.", en: "The AI plays the role of a scammer, but no real money is ever involved.", ja: "AIが詐欺師の役を演じますが、実際のお金は一切出ません。", zh: "AI扮演骗子角色，但绝不涉及真实金钱。", vi: "AI đóng vai kẻ lừa đảo, nhưng không có tiền thật nào liên quan.", es: "La IA hace de estafador, pero nunca se involucra dinero real." },
  video_label:       { ko: "홍보 영상", en: "Promotional Video", ja: "PR映像", zh: "宣传视频", vi: "Video giới thiệu", es: "Video promocional" },
  video_title:       { ko: "📺 소개 영상", en: "📺 Introduction Video", ja: "📺 紹介動画", zh: "📺 介绍视频", vi: "📺 Video giới thiệu", es: "📺 Video de introducción" },
  video_desc:        { ko: "범죄예방 체험관을 영상으로 먼저 확인해보세요", en: "Watch the intro video before you start", ja: "始める前に紹介動画をご覧ください", zh: "开始前先观看介绍视频", vi: "Xem video giới thiệu trước khi bắt đầu", es: "Mira el video introductorio antes de comenzar" },
  how_title:         { ko: "어떻게 체험하나요?", en: "How Does It Work?", ja: "どうやって体験しますか？", zh: "如何体验？", vi: "Cách trải nghiệm như thế nào?", es: "¿Cómo funciona?" },
  step1_title:       { ko: "시나리오 선택", en: "Choose a Scenario", ja: "シナリオ選択", zh: "选择场景", vi: "Chọn kịch bản", es: "Elige un escenario" },
  step1_desc:        { ko: "보이스피싱, 투자사기, 불법도박 등 9가지 실제 범죄 유형 중 하나를 선택합니다.", en: "Choose from 9 real crime types: voice phishing, investment fraud, illegal gambling, and more.", ja: "ボイスフィッシング、投資詐欺、違法賭博など9種類から選択します。", zh: "从电话诈骗、投资诈骗、非法赌博等9种真实犯罪类型中选择。", vi: "Chọn từ 9 loại tội phạm thực tế: lừa đảo điện thoại, gian lận đầu tư, cờ bạc bất hợp pháp, v.v.", es: "Elige entre 9 tipos de crimen real: phishing, fraude de inversión, juego ilegal y más." },
  step2_title:       { ko: "AI와 대화 체험", en: "Chat with AI Scammer", ja: "AIと会話体験", zh: "与AI骗子对话", vi: "Trò chuyện với AI lừa đảo", es: "Chatea con el estafador IA" },
  step2_desc:        { ko: "실제 사기범처럼 행동하는 AI와 대화하며 범죄 수법을 직접 경험합니다. 실제 돈은 나가지 않습니다.", en: "Chat with an AI acting like a real scammer. Experience the tactics firsthand. No real money involved.", ja: "実際の詐欺師のように行動するAIと会話し、犯罪手口を直接体験します。実際のお金は出ません。", zh: "与像真实骗子一样行动的AI对话，直接体验犯罪手法。不涉及真实金钱。", vi: "Trò chuyện với AI hành động như kẻ lừa đảo thật. Không có tiền thật.", es: "Chatea con una IA que actúa como estafador real. Sin dinero real." },
  step3_title:       { ko: "범죄 수법 확인", en: "Review Crime Tactics", ja: "犯罪手口確認", zh: "查看犯罪手法", vi: "Xem lại thủ thuật tội phạm", es: "Revisa las tácticas criminales" },
  step3_desc:        { ko: "체험 후 해당 범죄의 수법, 예방법, 신고 번호를 상세히 알려드립니다.", en: "After the experience, we explain the crime tactics, prevention tips, and report numbers in detail.", ja: "体験後、犯罪手口、予防法、通報番号を詳しくお伝えします。", zh: "体验后，我们将详细介绍犯罪手法、预防方法和举报电话。", vi: "Sau trải nghiệm, chúng tôi giải thích chi tiết thủ thuật, cách phòng ngừa và số báo cáo.", es: "Tras la experiencia, explicamos las tácticas, consejos de prevención y números de denuncia." },
  sc_section_title:  { ko: "9가지 범죄 시나리오", en: "9 Crime Scenarios", ja: "9つの犯罪シナリオ", zh: "9种犯罪场景", vi: "9 Kịch bản Tội phạm", es: "9 Escenarios de Crimen" },
  sc_section_sub:    { ko: "2024–2025년 실제 신고 데이터 기반으로 제작했습니다", en: "Based on 2024–2025 real reported crime data", ja: "2024〜2025年の実際の通報データに基づいて制作", zh: "基于2024-2025年真实报案数据制作", vi: "Được tạo dựa trên dữ liệu tội phạm thực tế 2024–2025", es: "Basado en datos reales de denuncias 2024–2025" },
  sc_all:            { ko: "전체 목록", en: "All Scenarios", ja: "全リスト", zh: "全部列表", vi: "Tất cả kịch bản", es: "Todos los escenarios" },
  rpt_section_title: { ko: "피해 즉시 신고하세요", en: "Report Immediately", ja: "被害を即座に通報してください", zh: "立即举报损失", vi: "Báo cáo ngay lập tức", es: "Denuncia de inmediato" },
  rpt_section_sub:   { ko: "범죄 피해를 당했거나 의심되면 즉시 전화하세요", en: "Call immediately if you're a victim or suspect a crime", ja: "犯罪被害を受けたり疑いがある場合は即座に電話してください", zh: "如果您遭受犯罪损失或有疑虑，请立即致电", vi: "Gọi ngay nếu bạn là nạn nhân hoặc nghi ngờ có tội phạm", es: "Llama de inmediato si eres víctima o sospechas un crimen" },
  rpt_police_org:    { ko: "경찰청 신고", en: "Police Report", ja: "警察庁通報", zh: "警察局举报", vi: "Báo cảnh sát", es: "Policía" },
  rpt_police_desc:   { ko: "즉각 신고·수사", en: "Immediate report & investigation", ja: "即時通報・捜査", zh: "立即举报·调查", vi: "Báo cáo & điều tra ngay", es: "Denuncia inmediata" },
  rpt_fss_org:       { ko: "금융감독원", en: "Financial Supervisory Service", ja: "金融監督院", zh: "金融监督院", vi: "Giám sát tài chính", es: "Supervisión financiera" },
  rpt_fss_desc:      { ko: "금융 피해 상담", en: "Financial fraud counseling", ja: "金融被害相談", zh: "金融损失咨询", vi: "Tư vấn thiệt hại tài chính", es: "Asesoría de fraude financiero" },
  rpt_kisa_org:      { ko: "인터넷진흥원", en: "Internet Security Agency", ja: "インターネット振興院", zh: "互联网振兴院", vi: "Cơ quan An ninh mạng", es: "Agencia de Internet" },
  rpt_kisa_desc:     { ko: "스미싱·해킹 신고", en: "Smishing & hacking report", ja: "スミッシング・ハッキング通報", zh: "短信诈骗·黑客举报", vi: "Báo smishing & hacking", es: "Denuncia smishing y hacking" },
  rpt_gamble_org:    { ko: "도박중독 상담", en: "Gambling Addiction Helpline", ja: "ギャンブル依存相談", zh: "赌博成瘾咨询", vi: "Tư vấn nghiện cờ bạc", es: "Línea de adicción al juego" },
  rpt_gamble_desc:   { ko: "24시간 무료 상담", en: "24h free counseling", ja: "24時間無料相談", zh: "24小时免费咨询", vi: "Tư vấn miễn phí 24h", es: "Asesoría gratuita 24h" },
  priv1_title:       { ko: "개인정보 수집 없음", en: "No Personal Data Collected", ja: "個人情報収集なし", zh: "不收集个人信息", vi: "Không thu thập dữ liệu cá nhân", es: "Sin datos personales" },
  priv1_desc:        { ko: "이름·전화번호·주민번호·계좌번호 등 어떠한 개인 신상정보도 수집하지 않습니다.", en: "We do not collect any personal information including name, phone, ID, or account numbers.", ja: "氏名・電話番号・住民番号・口座番号などいかなる個人情報も収集しません。", zh: "我们不收集任何个人信息，包括姓名、电话、身份证或账号。", vi: "Chúng tôi không thu thập bất kỳ thông tin cá nhân nào.", es: "No recopilamos ninguna información personal." },
  priv2_title:       { ko: "실제 금전 거래 없음", en: "No Real Financial Transactions", ja: "実際の金銭取引なし", zh: "无真实金融交易", vi: "Không có giao dịch tài chính thật", es: "Sin transacciones financieras reales" },
  priv2_desc:        { ko: "체험 중 표시되는 모든 금액과 계좌는 시뮬레이션입니다. 실제 이체·출금이 발생하지 않습니다.", en: "All amounts and accounts shown are simulations. No real transfers or withdrawals occur.", ja: "体験中に表示される金額や口座はすべてシミュレーションです。実際の送金・出金は発生しません。", zh: "体验中显示的所有金额和账户均为模拟，不会发生真实转账或提款。", vi: "Mọi số tiền và tài khoản hiển thị đều là mô phỏng. Không có giao dịch thật.", es: "Todos los montos y cuentas son simulaciones. No ocurren transferencias reales." },
  priv3_title:       { ko: "익명 통계만 수집", en: "Only Anonymous Statistics", ja: "匿名統計のみ収集", zh: "仅收集匿名统计数据", vi: "Chỉ thu thập thống kê ẩn danh", es: "Solo estadísticas anónimas" },
  priv3_desc:        { ko: "IP를 저장하지 않는 익명 방문 통계만 수집합니다.", en: "We only collect anonymous visit statistics without storing IP addresses.", ja: "IPを保存しない匿名訪問統計のみを収集します。", zh: "仅收集不存储IP地址的匿名访问统计数据。", vi: "Chúng tôi chỉ thu thập thống kê truy cập ẩn danh không lưu IP.", es: "Solo recopilamos estadísticas de visitas anónimas sin guardar IPs." },
  footer_brand_text: { ko: "범죄예방 체험관 · 교육 목적 전용 · AI Claude 협업 제작", en: "Crime Prevention Center · Educational Use Only · Made with AI Claude", ja: "犯罪予防体験館 · 教育目的専用 · AI Claude協働制作", zh: "犯罪预防体验馆 · 仅供教育目的 · 与AI Claude协作制作", vi: "Trung tâm Phòng chống Tội phạm · Chỉ dành cho giáo dục · Tạo với AI Claude", es: "Centro de Prevención del Crimen · Solo uso educativo · Hecho con AI Claude" },
  footer_disclaimer: { ko: "면책조항", en: "Disclaimer", ja: "免責事項", zh: "免责声明", vi: "Miễn trách nhiệm", es: "Descargo de responsabilidad" },
  stat1_lbl:         { ko: "2025년 보이스피싱 피해액", en: "2025 Voice Phishing Losses", ja: "2025年ボイスフィッシング被害額", zh: "2025年电话诈骗损失", vi: "Thiệt hại lừa đảo 2025", es: "Pérdidas por phishing 2025" },
  stat2_lbl:         { ko: "연간 피해 신고 건수", en: "Annual Crime Reports", ja: "年間被害通報件数", zh: "年度犯罪举报数量", vi: "Số báo cáo hàng năm", es: "Denuncias anuales" },
  stat3_lbl:         { ko: "1건당 평균 피해액", en: "Avg. Loss per Case", ja: "1件あたり平均被害額", zh: "每案平均损失", vi: "Thiệt hại trung bình mỗi vụ", es: "Pérdida promedio por caso" },
  stat4_lbl:         { ko: "도박 중독 추정 인구", en: "Estimated Gambling Addicts", ja: "ギャンブル依存症推定人口", zh: "估计赌博成瘾人数", vi: "Ước tính người nghiện cờ bạc", es: "Adictos al juego estimados" },
  hero_edu_full:     { ko: "이 플랫폼은 순수 교육 목적입니다. AI가 사기범 역할을 연기하지만 실제 돈은 절대 나가지 않습니다.", en: "This platform is purely for education. The AI plays a scammer, but no real money is ever sent.", ja: "このプラットフォームは純粋に教育目的です。AIが詐欺師の役を演じますが、実際のお金は一切出ません。", zh: "本平台纯粹用于教育目的。AI扮演骗子，但绝不会转出真实金钱。", vi: "Nền tảng này hoàn toàn vì mục đích giáo dục. AI đóng vai kẻ lừa đảo, nhưng không có tiền thật.", es: "Esta plataforma es puramente educativa. La IA hace de estafador, pero nunca se envía dinero real." },
} as const;
